...
namespace UnityMovementAI
{
    public class Spawner : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Vector3 topRight = new Vector3(transform.position.x + 10, 0, transform.position.z - 10);

            // Botton-Left side
            // bottomLeft = Camera.main.ViewportToWorldPoint(new Vector3(0, 0, distAway));
            bottomLeft = new Vector3(transform.position.x - 10, 0, transform.position.z + 10);

            // Rectangle of spawing
